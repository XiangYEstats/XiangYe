...
My PhD research focuses on Bayesian latent variable models, spanning prior specification and model construction, and their applications. During my PhD, I have developed these ideas in the context of directional (circular) statistics, implementing these methodologies into the Integrated Nested Laplace Approximation (INLA) R package.
...
### Research Interests
My research interests center on efficient, tractable, and explainable approaches to statistical inference and learning from data. I am especially interested in the synergy between Bayesian inference and modern high-dimensional learning algorithms to develop methodologies for real-world problems.
...
* Ye, X., Van Niekerk, J. and Rue, H., 2026. A Bayesian regression framework for circular models with INLA. arXiv preprint arXiv:2602.08413.
