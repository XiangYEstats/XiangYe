...
My research interests lie in a broad domain related to efficient, tractable, and explainable approaches to learning from data. I am especially interested in the synergy between Bayesian philosophy and modern high-dimensional learning frameworks and inference algorithms for developing methodologies to solve real-world problems.

* **Hierarchical Bayesian latent variable modeling** – modeling unobservable structures and information underlying observed data
* **scalable probabilistic modeling** – using structured latent representations to handle high-dimensional data
