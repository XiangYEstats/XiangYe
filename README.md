...
| Research directions, projects, and articles | `site_data.py` → `RESEARCH_DIRECTIONS` |
...
| Research / Activity / About / Contact structure | matching file under `templates/` |
...
## Pages retained from the previous site
